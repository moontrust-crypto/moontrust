...
describe("TinFitToken (Tax Multiplicator: 0.5)", () => {
    ...
    before(async () => {
        ...
        // set tax rate multiplicator to 50%
        await token.connect(owner).setTaxMultiplicator(50);
    });
    ...
    it("4. Wallet B sends 50000 token to wallet C", async () => {
        ...
        let expectedTax: BigNumber = BigNumber.from("2500" + digits);
